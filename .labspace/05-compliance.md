...
```bash
docker scout attest list demonstrationorg/demo-python-dhi:v1 --platform linux/arm64
```
...
```bash
docker scout vex get demonstrationorg/demo-python-dhi:v1 --output vex.json
```
